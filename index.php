...
<html lang="pt_BR">
  <head>
    ...
    <title>Report Agglomeration</title>
    ...
    <div id="page-consulta">
      <aside class="animate-right">
        ...
        <footer>
          ...
          <div class="perfil">
            <button type="button" name="drop"><img id="avatar" src="<?php echo $_SESSION['picture'] ?>"></button>
            <div class="drop-content">
              <a><span id="user-name">Olá <?php echo $_SESSION["first_name"]; ?>!<br></a>
      ...
      <a href="indices.html" class="indices" title="Indices aglomeração">
        <img src="./public/images/graph.svg" alt="Indices aglomeração" />
      </a>

      <a href="add-aglomeracao.html" class="add-aglomeracao" title="Adicione uma aglomeração">
        <img src="./public/images/plus.svg" alt="Adicione uma aglomeração" />
      </a>
    </div>
    <script src="./public/scripts/page-consulta.js"></script>
